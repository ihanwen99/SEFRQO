...
if __name__ == "__main__":
    # 使用示例
    directory = "/home/qihanzha/LLM4QO/sql/tpcds"
    database = "tpcds1load"
    connection_info = {
        "host": "127.0.0.1",
        "port": 5438,
    ...
    for sql_file in sql_files:
        ...
        with open(f"/home/qihanzha/LLM4QO/src/tpcds_inspect/original_hints/{index}.json", "w") as f:
            f.write(plan_result)
        
        bracket_hint = print_plan_bracket(plan_result, print_dummy_join=False)
    
        with open(f"/home/qihanzha/LLM4QO/src/tpcds_inspect/original_hints/{index}_bracket_hint.txt", "w", encoding="utf-8") as f:
