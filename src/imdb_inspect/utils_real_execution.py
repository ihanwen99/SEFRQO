...
if __name__ == "__main__":
    # 使用示例
    directory = "/home/qihanzha/LLM4QO/sql/imdb_job_set"
    database = "imdbload"
    foldername = "imdb_job_set"
    connection_info = {
        "host": "127.0.0.1",
        "port": 5438,
        "database": database,
    ...
    # 输出目录，写入json和txt文件
    output_folder = f"/home/qihanzha/LLM4QO/src/imdb_inspect/original_hints_real_execution/{foldername}"
    # 如果输出目录不存在，则创建该目录
