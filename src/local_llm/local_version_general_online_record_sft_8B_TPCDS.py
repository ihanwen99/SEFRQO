...
DOMAIN_FILE = "/home/your_username/LLM4QO/src/local_llm/prompts/TPCDS/domain.nl"
INIT_VEC_QUERIES_DIR = "/home/your_username/LLM4QO/src/local_llm/prompts/TPCDS/tpcds_ref_queries_with_time.sql"
TEST_SQL_DIR = "/home/your_username/LLM4QO/sql/tpcds"
...
for current_iteration in range(NUM_ITERATIONS):
    ...
    for i in range(1, number_of_questions+1):
        ...
        # FIXME for tpcds try to save token
        # messages = []
    ...
    if (current_iteration+ 1) % 5 == 0:
        send_email("llmqo LOCAL Experiment test1 tpcds", f"The experiment of tpcds finished! The iteration is {current_iteration + 1}", "")
