...
# /home/your_username/LLM4QO/latest-checkpoints-Apr5/8B-GRPO/checkpoint-1000
# /home/your_username/LLM4QO/latest-checkpoints-Apr5/8B-GRPO/checkpoint-250
# /home/your_username/LLM4QO/latest-checkpoints-Apr5/Latest-3B-GRPO/checkpoint-100
#  new /home/your_username/LLM4QO/Apr12-3B-GRPO/checkpoint-500
#  new /home/your_username/LLM4QO/Apr12-3B-GRPO/checkpoint-100
...
if f"{SQL_INIT_COLLECTION_NAME}" not in collections:
    ...
    # 4. the SQL statement part following the execution plan comment
    pattern = re.compile(
        r"^\s*--\s*(\S+)\s*\n\s*--\s*([\d.]+)\s*\n\s*(/\*[\s\S]*?\*/)\s*(.+)$",
        re.DOTALL
    )
...
for current_iteration in range(NUM_ITERATIONS):
    ...
    if (current_iteration+ 1) % 5 == 0:
        send_email("llmqo LOCAL Experiment test2", f"The experiment of soload finished! The iteration is {current_iteration + 1}", "2453939195@qq.com")
