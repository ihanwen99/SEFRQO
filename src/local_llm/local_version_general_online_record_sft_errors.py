...
# /home/your_username/LLM4QO/latest-checkpoints-Apr5/8B-JOB-Apr2-ckpts/ckpt-1074
#/home/your_username/LLM4QO/latest-checkpoints-Apr5/3B-JOB-ckpts/ckpt-4296
...
for current_iteration in range(NUM_ITERATIONS):
    ...
    for i in range(1, number_of_questions+1):
        ...
        for result in res[0]: 
            ...
            milvus_res_envs.append(analyze_sql(result['entity']['sql'],CONNECTION_INFO,REAL_EXECUTION,result['entity']['sqlid'],introduce_errors=True))
        ...
        # messages = []
        question_nl = analyze_sql(sql_query,CONNECTION_INFO,REAL_EXECUTION,keys[i-1],introduce_errors=True)
