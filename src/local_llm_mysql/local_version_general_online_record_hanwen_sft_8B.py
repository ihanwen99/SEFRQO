...
# Initialize LLM with parameters to handle CUDA driver issues
print("Initializing LLM with CUDA driver compatibility settings...")
client_gpt = LLM(
...
for current_iteration in range(NUM_ITERATIONS):
    ...
    if (current_iteration+ 1) % 5 == 0:
        send_email("llmqo LOCAL Experiment test2", f"The experiment of imdbload finished! The iteration is {current_iteration + 1}", "your_email@example.com")
