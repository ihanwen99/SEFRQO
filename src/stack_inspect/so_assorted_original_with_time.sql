...
-- q6-001.sql
-- 15.366
/*+ NestedLoop(t1 s1 tq1 q1 u1 account c1)
 NestedLoop(t1 s1 tq1 q1 u1 account)
 NestedLoop(t1 s1 tq1 q1 u1)
 NestedLoop(t1 s1 tq1 q1)
 NestedLoop(t1 s1 tq1)
 MergeJoin(t1 s1)
 ...
 IndexScan(account)
 IndexScan(c1)
 Leading(((((((t1 s1) tq1) q1) u1) account) c1)) */
select COUNT(distinct account.display_name)
from
tag t1, site s1, question q1, tag_question tq1, so_user u1, comment c1,
account
...
-- q7-004.sql
-- 1646.271
/*+ NestedLoop(b1 so_user account b2)
 HashJoin(b1 so_user account)
